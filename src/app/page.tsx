...
export default async function Component() {
  ...
  return (
    <main className="mx-auto flex w-full max-w-screen-2xl flex-grow flex-col items-center justify-center overflow-x-hidden py-6 xl:pt-[calc(30vh-3.25rem)]">
      ...
      <div className="absolute left-1/2 top-1/2 -z-10 h-32 w-96 -translate-x-[calc(50%+16rem)] -translate-y-full -rotate-45 rounded-full bg-pink-500/20 blur-[128px]" />
      <div className="absolute left-1/2 top-1/2 -z-10 h-32 w-96 -translate-x-1/2 -translate-y-full -rotate-45 rounded-full bg-purple-500/20 blur-[128px]" />
      <div className="absolute left-1/2 top-1/2 -z-10 h-32 w-96 -translate-x-[calc(50%-16rem)] -translate-y-full -rotate-45 rounded-full bg-blue-500/20 blur-[128px]" />
      <div className="absolute left-0 top-0 -z-20 h-full w-full bg-[radial-gradient(black_1px,_transparent_0)] bg-[length:40px_40px] [mask-image:linear-gradient(165deg,red,transparent_69%)]" />
